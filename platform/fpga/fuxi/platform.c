...
#define PLATFORM_PLIC_ADDR		0x11010000
#define PLATFORM_PLIC_NUM_SOURCES	64
#define PLATFORM_HART_COUNT		1
#define PLATFORM_CLINT_ADDR		0x11000000
#define PLATFORM_UART_ADDR		0x11041000
...
static int platform_console_init(void)
{
	...
	return uart8250_init(PLATFORM_UART_ADDR,
			...
			PLATFORM_UART_REG_SHIFT,
			PLATFORM_UART_REG_WIDTH);
}
